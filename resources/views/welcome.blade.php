    ...
    <section class="h-full w-full">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-xl font-semibold text-gray-900 dark:text-white">
                <img class="w-12 h-12 mr-1" src="{{ asset('/images/logo.svg') }}" alt="logo">
                Kelompok 1
            </a>
            <div class="w-full rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700 bg-gray-100 backdrop-filter backdrop-blur-md bg-opacity-20">
