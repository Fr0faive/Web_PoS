        ...
        <div class="p-4 rounded shadow-md bg-white backdrop-filter backdrop-blur-md bg-opacity-40">
            <div class="flex">
                ...
                <div class="flex-none w-80 p-2">
                    <div class="flex mb-2">
                        <input type="text" name="keyword" id="search_product" class="rounded-none rounded-l-md bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 block flex-1 min-w-0 w-1 text-sm p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Masukkan Barcode / Nama Barang">
                        <button type="button" id="btn_search" class="inline-flex items-center px-3 text-sm text-white border border-l-0 rounded-l-none rounded-r-md bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700" data-id_product="${data.id_produk}" data-harga="${data.harga}">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex container-qty">
                                    <span class="inline-flex left-btn items-center px-2 text-sm text-gray-900 border border-r-0 rounded-r-none rounded-l-md bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    ...
                                    <span class="inline-flex right-btn items-center px-2 text-sm text-gray-900 border border-l-0 rounded-l-none rounded-r-md bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
